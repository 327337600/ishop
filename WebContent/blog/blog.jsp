...
$(function(){
	$.get(ctx+"/blog/getBlog/2",function(res){
		...
		<div class="manage_head">
			...
			<div id="nav">
				<ul>
					...
					<li><a href="<%=request.getContextPath()%>/blog"><b>Blog管理</b></a></li>
				</ul>
			</div>
		</div>
		<div class="main">
<h1>Blog管理&nbsp;&nbsp;
<a href="<%=request.getContextPath()%>/blog/add">创建Blog</a>
</h1>
<div class="table_box">
	<table class="list">
		<tbody>
			...
			<tr>
				...
				<td style="text-align:left;">
					&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/blog/delete/${blog.id}">删除</a>
					&nbsp;&nbsp;<a href="<%=request.getContextPath()%>/blog/edit/${blog.id}">修改</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
